...
class SyncHttpClient(
     ...
     *
     * [OkHttpTransport] already refuses an oversized body without reading it. This second check
     ...
     */
    private val maxResponseBytes: Int = OkHttpTransport.DEFAULT_MAX_RESPONSE_BYTES,
) : SyncApi {
    ...
    companion object {
        ...
        /**
         * The production constructor: a client talking to [endpoint] over OkHttp.
         *
