...
data class SealedRecord(val blindedId: String, val envelope: ByteArray) {
 ...
 *
 * The **only** place in this module that touches `K_content` or `K_id`. Everything above it deals
 * in payloads and everything below it deals in opaque blobs, which is what keeps the account keys
 * out of the repository, the UI and the store.
 *
